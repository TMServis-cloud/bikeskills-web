  ...
  document.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      if (textEl) textEl.innerHTML =
        ...
        `Na zadaný mail vám také posíláme potvrzení, že byla zpráva odeslána. ` +
      ...
      if (btn) { btn.disabled = false; btn.textContent = 'Odeslat přihlášku'; }
      showError('Nepodařilo se odeslat přihlášku. Zkuste to prosím znovu nebo nás kontaktujte přímo na info@bikeskills.cz.');
    }
  });
})();
